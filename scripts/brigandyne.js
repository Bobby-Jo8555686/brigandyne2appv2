...
Hooks.once("init", async function() {
    ...
    // 🔥 Écoute Globale : Marche dans le Chat ET dans les Pop-ups flottants
    // ==========================================
    // ==========================================
    // BOUTONS DANS LE CHAT (Sauvegardes & Inversions de dés)
    // ==========================================
    Hooks.once("ready", () => {
        document.body.addEventListener("click", async (ev) => {
            ...
            if (btn) {
                ...
                } catch (err) { console.error("Brigandyne | Erreur Inversion Stat:", err); }
                return;
            }
            ...
            if (btn) {
                ...
                } catch (err) { console.error("Brigandyne | Erreur Inversion Arme:", err); }
                return;
            }
            ...
            if (btn) {
                ...
                } catch (err) { console.error("Brigandyne | Erreur Inversion Sort:", err); }
                return;
            }
        });
    });
